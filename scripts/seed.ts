...
async function seed() {
  ...
  const testEmployees = [
    { nric: "S1234567A", name: "Tan Wei Ming", dob: "1985-03-15", status: "SC" as const, dept: "Doctor", pos: "Senior Doctor", salary: 1200000 },
    { nric: "S2345678B", name: "Lim Mei Ling", dob: "1990-07-22", status: "SC" as const, dept: "Nurse", pos: "Staff Nurse", salary: 450000 },
    { nric: "S3456789C", name: "Ahmad bin Hassan", dob: "1968-11-05", status: "SC" as const, dept: "Admin", pos: "Receptionist", salary: 300000 },
    { nric: "G4567890D", name: "Maria Santos", dob: "1995-01-30", status: "FW" as const, dept: "Nurse", pos: "Enrolled Nurse", salary: 280000 },
    { nric: "S5678901E", name: "Wong Kai Wen", dob: "1975-06-18", status: "PR3" as const, dept: "Doctor", pos: "Locum Doctor", salary: 800000 },
  ];
