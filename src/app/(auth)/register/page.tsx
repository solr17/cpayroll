...
export default function RegisterPage() {
  ...
  function validate(): string | null {
    ...
    if (!/^[A-Za-z0-9]{9,10}$/.test(uen.trim())) return "UEN must be 9-10 alphanumeric characters";
    return null;
  }
      ...
      <div className="flex w-full items-center justify-center bg-white px-6 py-12 sm:px-12 lg:w-1/2 xl:w-[45%]">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            ...
            <p className="mt-1.5 text-sm text-slate-500">Get started with ClinicPay in minutes</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                required
                placeholder="ABC Medical Clinic Pte Ltd"
            ...
            <div>
              <label htmlFor="uen" className="block text-sm font-medium text-slate-700">
              ...
              <p className="mt-1 text-xs text-slate-400">
                9-10 character alphanumeric identifier from ACRA
              </p>
            </div>
